...
Я разрабатываю web-приложения в течении 4 лет, и в течении одного года на коммерческой основе.

* 🚀  Сейчас я работаю над: [AngularProject](https://github.com/plonkton228/Angular)
* 🧠  Изучаю: GraphQl, Next.js, Angular
--------
### Front-end:
<div> 
